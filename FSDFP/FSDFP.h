...
//! Project version number for FSDFP.
FOUNDATION_EXPORT double FSDFPVersionNumber;

//! Project version string for FSDFP.
FOUNDATION_EXPORT const unsigned char FSDFPVersionString[];
