...
@objc(FSDFPBannerViewVariantN)
open class FSDFPBannerViewVariantN: DFPNOctagonBannerView, GADBannerViewDelegate {
    ...
    @objc public var fsRefreshRate:TimeInterval {
        ...
        set(newValue) {
            ...
            fsTimer = FSWeakGCDTimer.scheduledTimer(withTimeInterval: newValue,
                                                    ...
                                                    userInfo: nil,
                                                    repeats: true,
                                                    dispatchQueue: FSDFPBannerViewVariantN.fsQueue)
